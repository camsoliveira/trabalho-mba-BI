...
WHILE ano_inicio <= ano_final loop
   ...
   ELSIF (mes >=9 and mes<11) then
    ...
    INSERT INTO TRAB_DIM_TEMPO (DTC_DATA,NUM_ANO, NUM_DIA, NUM_MES, SK_TEMPO, DES_ANO_MES,DES_MES_ANO_NUMERICO,DES_MES_ANO_COMPLETO,DES_MES_ANO,DES_DATA_DIA,DES_DIA, DES_MES, DES_QUINZENA, DES_SEMESTRE, DES_TRIMESTRE, NUM_NIVEL, NUM_QUINZENA, NUM_SEMESTRE, NUM_TRIMESTRE, IND_FINAL_SEMANA, DES_BIMESTRE, DES_QUADRIMESTRE, NUM_BIMESTRE, NUM_QUADRIMESTRE)
